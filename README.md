...
A compile → verify → benchmark pipeline for Ascend C operators, with built-in multi-NPU parallel evaluation.

Part of [evotoolkit](https://github.com/pgg3/evotoolkit).
